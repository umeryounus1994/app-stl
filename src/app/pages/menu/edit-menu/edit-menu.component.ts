...
export class EditMenuComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.pageTitle = this.variationData.pageTitle;
    this.pageText = this.variationData.pageText;
    this.downLeftBtnHyperlink = this.variationData.downLeftBtnHyperlink;
    this.downLeftBtnText = this.variationData.downLeftBtnText;
    this.downRightConfirmBtnText = this.variationData.downRightConfirmBtnText;
   
    this.downloadedCategoryIcon.push(this.variationData.icon)
    this.downloadedCategoryDefaultImage.push(this.variationData.downRightConfirmBtnIcon);
  ...
  _sendSaveRequest() {
    ...
    const formData: any = new FormData();
      ...
      this.api.patch('menu/update/', this.menuId, formData).then((response: any) => {
