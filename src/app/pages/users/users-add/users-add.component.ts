...
export class UsersAddComponent implements OnInit {
  ...
  _sendSaveRequest() {
    ...
    this.api.post('admin/signup_Admin', d).then((response: any) => {

      this.helper.successBigToast('Success', 'User Successfully Added!');
      this.ngOnInit();
  ...
  validate(){
    ...
    if(this.password === '' || this.password == undefined) {
      this.helper.failureToast("Faliure","Password is required");
      return false;
    } 
    else{
      return true;
